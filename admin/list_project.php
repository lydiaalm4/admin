    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">List of projects</h1>
            </div>

            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white">List of projects</div>
                        <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php while ($donnee = $res->fetch()){?>
                                        <tr>
                                            ...
                                            <td><?php echo $donnee['domaine'] ?></td>
                                            <td><input type="button" class="btn btn-primary" onclick="location.href='detail_project.php';" value="Description"></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
